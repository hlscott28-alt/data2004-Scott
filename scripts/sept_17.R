...
#The foreign key is a supporter to the main dataset. In this Crashes in Primary Persons is foreign
...
#We know there are some records that do not have person records involved

#Combining Grains - One row represent one crash record with person level crash
